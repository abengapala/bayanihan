  ...
  return (
    <div className="flex flex-col gap-6 animate-fade-in">
      ...
      <div className="mb-2">
        ...
        <p className="text-slate-500">{t('directory.subtitle')}</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredOffices.length === 0 ? (
          <div className="col-span-full py-12 text-center bg-slate-50 rounded-xl border border-dashed border-slate-300">
            ...
            <h3 className="text-lg font-medium text-slate-900 mb-1">{t('directory.noResults')}</h3>
            <p className="text-slate-500">{t('directory.noResultsSub')}</p>
          </div>
        ) : (
